        ...
        <div className="p-4 pt-32 flex justify-center">
          <div className="bg-white p-4 rounded-lg shadow-lg" style={{minWidth: 400, width: 450}}>
            <div className="flex justify-between mb-5">
              <span className="text-lg font-bold">Add liquidity</span>
            </div>
            <div className="p-4">
              <div>
              ...
              <div className="relative mt-4 mb-4" style={{height: 1, background: '#033C6C1A'}}>
                <img
                  ...
                  className="cursor-pointer absolute inset-2/4 transform -translate-x-1/4 -translate-y-2/4" 
                />
              </div>
              <div>
                <p className="font-bold">Input</p>
            ...
            <button className="rounded-md w-full text-white font-bold mt-3 bg-orange py-3" onClick={() => setModalName('confirmModal')}>PROCEED</button>
          </div>
        </div>
      </div>
      {
